package portfolioAnalystUtility;
...
public class Utility {
	...
	public static String readExcelSheet(int row,int cell) throws EncryptedDocumentException, IOException {
		 File myFile = new File("C:\\Users\\umesh\\Desktop\\portfolioAnalyst.xlsx");
		...
		public static String readPropertyFile(String key) throws IOException  {
			...
			FileInputStream myFile = new FileInputStream("C:\\Users\\umesh\\eclipse-workspace\\PortfolioAnalyst_Standalone_Application\\portfolioAnalyst.properties");
